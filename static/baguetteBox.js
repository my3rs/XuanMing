        ...
        function() {
            ...
            function S(e) {
                if (w.hasOwnProperty(e)) {
                    var t = w[e].galleries; [].forEach.call(t,
                ...
                "block" !== r.style.display && (U(document, "keydown", F), i = {
                    ...
                    q(o = e,
                        function() {
                            z(o),
                                V(o)
                        }), R(), r.style.display = "block", b.fullScreen &&
                function t() {
            ...
            function q(t, n) {
                var e = k[t],
                    o = h[t];
                if (void 0 !== e && void 0 !== o) if (e.getElementsByTagName("img")[0]) n && n();
                else {
            ...
            function M(e, t) {
                return ! n && 0 <= e && e < t.length ? (H(t, b), I(e), !0) : e < 0 ? (b.animation && O("left"), !1) : e >= k.length ? (b.animation && O("right"), !1) : (q(o = e,
                    function() {
                        z(o),
                            V(o)
            ...
            }),
                {
                    run: function K(e, t) {
                        return m.transforms = function n() {
                            ...
                            function a() {
                                if (r = G("baguetteBox-overlay")) return l = G("baguetteBox-slider"),
                                    u = G("previous-button"),
                                    c = G("next-button"),
                                    void(d = G("close-button")); (r = J("div")).setAttribute("role", "dialog"),
